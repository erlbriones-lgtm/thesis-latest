...
=====================================================`;
    ...
    function handleUrlQueryParameters() {
        ...
        const isFeedbackKiosk = !isAdmin && (kioskParam === 'true' || kioskParam === '1' || modeParam === 'kiosk' || modeParam === 'qr' || modeParam === 'feedback' || Boolean(officeParam));
        const isQrScan = !isAdmin && (urlParams.has('office') || urlParams.has('kiosk') || modeParam === 'qr' || urlParams.has('qr') || urlParams.has('station') || urlParams.get('source') === 'qr');
    ...
    function isUserFromQrOrOfficeLink() {
        ...
        const hasQrParam = urlParams.has('qr') || sourceParam === 'qr' || modeParam === 'qr';
        const hasKioskParam = kioskParam === 'true' || kioskParam === '1' || modeParam === 'kiosk';
        ...
        return hasOfficeParam || hasQrParam || hasKioskParam || hasStationParam || isStoredQrOrOfficeUser;
    }
